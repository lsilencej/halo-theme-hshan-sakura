var post = {
    ...
    initToc: function () {
        ...
        $('.toc-link').prepend(document.createElement("span"));
        $('.toc-link span').addClass('toc-link-dot');
    ...
    scrollTocFixed: function () {
        if (!post.checkToc()) {
            document.removeEventListener('scroll', post.tocScroll, false);
        }
        document.addEventListener("scroll", post.tocScroll, false);
    },
